...
# NOTE: llama-3.3-70b-versatile (the old default here) was decommissioned
# by Groq on 2026-08-16 — any request using it now 404s with
# model_not_found regardless of API key. openai/gpt-oss-120b is Groq's
# own recommended replacement for it. Override via GROQ_MODEL in .env if
# you'd rather use qwen/qwen3.6-27b or something else.
MAX_HISTORY  = 40
...
GOOGLE_REDIRECT_URI  = os.getenv("GOOGLE_REDIRECT_URI", "http://localhost:8765/callback")
GOOGLE_API_KEY       = os.getenv("GOOGLE_API_KEY", "")  # simple API key for YouTube/Translate/Maps
